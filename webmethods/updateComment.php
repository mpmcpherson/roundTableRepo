...
if ($alt[0] < 4) {
    ...
    $result = mysqli_query($dbhandle, "INSERT INTO task_info (task_message, post_id, status, created_date) select m.task_message, m.post_id,0,UTC_DATE() from task_info m WHERE task_info_id = $task_id;");
